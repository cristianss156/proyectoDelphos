...
function amonestar(_curso, _alumno, _fecha, _hora, _asignatura, _causa){
	...
	objAjax.open("GET","http://localhost/Trabajo Cliente/php/amonestar.php?datosAmonestacion="+jsonstring, true);
	objAjax.send();
...
function expulsar(_curso, _alumno, _fecha, _hora, _asignatura, _causa){
	...
	objAjax.open("GET","http://localhost/Trabajo Cliente/php/expulsar.php?datosExpulsion="+jsonstring, true);
	objAjax.send();
...
function firmar(_fecha){
	...
	objAjax.open("GET","http://localhost/Trabajo Cliente/php/firmar.php?datosFirma="+jsonstring, true);
	objAjax.send();
...
function sancionar(_fecha, _sancion){
	...
	objAjax.open("GET","http://localhost/Trabajo Cliente/php/sancionar.php?datosSancion="+jsonstring, true);
	objAjax.send();
