...
function rellenarProf(){
	...
	objAjax.open("GET","http://localhost/Trabajo Cliente/php/buscarProf.php", true);
	objAjax.send();
...
function rellenarCursos(){
	...
	objAjax.open("GET","http://localhost/Trabajo Cliente/php/listarCursos.php", true);
	objAjax.send();
...
function buscarAmoExp(dni){
	...
	objAjax.open("GET","http://localhost/Trabajo Cliente/php/buscarAmoExpAlumn.php?dni="+dni, true);
	objAjax.send();
...
function alumnosSinFirma(){
	...
	objAjax.open("GET","http://localhost/Trabajo Cliente/php/buscarAlumnosSinFirma.php", true);
	objAjax.send();
...
function amoProfesor(prof){
	...
	objAjax.open("GET","http://localhost/Trabajo Cliente/php/buscarAmoProf.php?prof="+prof, true);
	objAjax.send();
...
function amoExpGrp(grupo){
	...
	objAjax.open("GET","http://localhost/Trabajo Cliente/php/buscarAmoExpGrp.php?grp="+grupo, true);
	objAjax.send();
...
function profesoresAmoTotal(){
	...
	objAjax.open("GET","http://localhost/Trabajo Cliente/php/buscarAmoTotal.php", true);
	objAjax.send();
