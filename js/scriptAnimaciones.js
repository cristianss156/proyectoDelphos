...
function aplicarFecha( fecha ) {
	var objFecha = document.getElementById("fech_firma");
	objFecha.min = fecha;
	objFecha.value = fecha;
}

function aplicarFechaSan( fecha ) {
	var objFecha = document.getElementById("fech_Sancion");
	objFecha.min = fecha;
	objFecha.value = fecha;
}
...
function animar() {
	if($("#middle").width() === 0) {
		...
		$("#semiUno, #semiDos, #middleUno, #middleDos").css({'boxShadow':'none'});
