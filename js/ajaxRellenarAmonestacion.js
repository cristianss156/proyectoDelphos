...
function rellenarAlumnos(_curso){
	curso=_curso;
	crearAjax();
	objAjax.open("GET","http://localhost/Trabajo Cliente/php/listarAlumnos.php?curso="+_curso, true);
	objAjax.send();
...
function rellenarAsignaturas(_curso){
	crearAjax();
	objAjax.open("GET","http://localhost/Trabajo Cliente/php/listarAsignaturas.php?curso="+_curso, true);
	objAjax.send();
...
function rellenarCausasAmonestacion(){
	crearAjax();
	objAjax.open("GET","http://localhost/Trabajo Cliente/php/listarCausasAmonestacion.php", true);
	objAjax.send();
...
function crearCausaAmonestacion(nuevaCausaAmo){
	if(nuevaCausaAmo===""){
		...
		crearAjax();
		objAjax.open("GET","http://localhost/Trabajo Cliente/php/crearCausaAmonestacion.php?causa="+nuevaCausaAmo, true);
		objAjax.send();
